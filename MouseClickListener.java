...
public class MouseClickListener implements MouseListener
{
    ...
    /**
     * Creates a new apple based on the click that was released, previous click, and
    ...
    public void mouseReleased(MouseEvent me)
    {
        ...
        { 
            ...
            if( me.getButton() == MouseEvent.BUTTON3 && totalTimePressed <
            NORMAL_APPLE_CLICK_LIMIT )
                game.getApples().add( new Apple( game.getWidth(), game.getHeight(),
                me.getX() ,true ) );
            else if( me.getButton() == MouseEvent.BUTTON1 && totalTimePressed <
            NORMAL_APPLE_CLICK_LIMIT )
                game.getApples().add( new Apple( game.getWidth(), game.getHeight(),
                me.getX() ) );
            else
